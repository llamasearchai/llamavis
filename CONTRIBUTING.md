# Contributing to LlamaVis

Thank you for your interest in contributing to LlamaVis! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaVis:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamavis.git
   cd llamavis
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamavis.git
   ```
...
By contributing to LlamaVis, you agree that your contributions will be licensed under the project's MIT License.
