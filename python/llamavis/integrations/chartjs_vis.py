...
from ..core.utils import generate_color_scale, generate_unique_id, safe_json_value
...
class ChartJSVisualization(Visualization):
    ...
    def preprocess_data(self) -> Dict[str, Any]:
        ...
        if hasattr(self.data, "columns") and hasattr(self.data, "values"):
            ...
            return DataProcessor.pivot_for_chart(
                df, x_col, y_cols[0] if y_cols else None
            )
