    ...
    def render_html(
        ...
        for module in additional_modules:
            if module in Renderer.ADDITIONAL_MODULES:
                lib_tags.append(
                    f'<script src="{Renderer.ADDITIONAL_MODULES[module]}"></script>'
                )
...
<body>
    ...
    @staticmethod
    def save_html(html: str, filepath: str, overwrite: bool = True) -> str:
        """
        Save HTML to a file.
    ...
    def generate_script_tag(
        code: str, is_module: bool = False, script_id: Optional[str] = None
    ) -> str:
        """
